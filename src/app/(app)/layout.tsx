...
function Sidebar({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  return (
    <>
      ...
      {/* Sidebar effettiva */}
      <aside className={`fixed top-0 left-0 h-screen bg-gray-800 text-white w-64 z-30 transform transition-transform md:relative md:transform-none flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
